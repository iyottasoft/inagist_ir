...
ERL_NIF_TERM nif_get_named_entities(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
  ...
  return enif_make_tuple3(env, safe_status_term, script_term, named_entities_list);
...
ERL_NIF_TERM nif_test_twitter_timeline(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
  ...
  while (tweet_start && tweet_end && *tweet_end != '\0') {
    ...
    *tweet_end = '\0';
    ...
    tuple6 = nif_get_named_entities(env, 1, arg_array);
...
{
  {"init_c", 1, nif_init_c},
  {"get_named_entities", 1, nif_get_named_entities},
  {"test_named_entities_twitter_timeline", 0, nif_test_twitter_timeline},
  {"test_named_entities_twitter_timeline", 1, nif_test_twitter_timeline},
  {"test_named_entities_file", 1, nif_test_from_file},
};
ERL_NIF_INIT(named_entities, nif_funcs, NULL, NULL, NULL, NULL)
