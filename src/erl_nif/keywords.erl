...
-export([init/0, init_c/1, get_keywords/1, test_init/0, test/0, test_user/1, test_file/0, test_keywords_twitter_timeline/0, test_keywords_twitter_timeline/1, stress_test_keywords/1]).

init() ->
  erlang:load_nif("../../lib/libkeywords_erl", 0).
