...
int main(int argc, char *argv[]) {
  ...
  std::string language_classifier_config = std::string(argv[2]);
  ...
  inagist::GistCollector gc;

  if (gc.Init(keytuples_extracter_config.c_str()
#ifdef LANG_ENABLED
              , language_classifier_config.c_str()
#endif // LANG_ENABLED
