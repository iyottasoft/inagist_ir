...
class TwitterSearcher {
 public:
  ...
  int GetTweetsFromUsers(const std::set<std::string>& handles, std::set<std::string>& tweets);
  int GetRetweetStatsForUser(const std::string& handle, const std::string& output_file_name);
